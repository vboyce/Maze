...
LEXICON = lexicon_generator.load_distractor_dict('distractor_list.json')

def get_unigram_freq(word):
    '''arguments: word - string
	returns unigram frequency '''
    raw_freq = zipf_frequency(word,'fr') # use wordfreq to get log frequency
