...
class wordfreq_French_dict(distractor_dict):
    ...
    def __init__(self, params={}):
        ...
        include = params.get("include_words", "french_data/frwac_vocab.txt") #this is just a generic french dictionary, not matched to model
...
def get_frequency(word):
    ...
    return wordfreq.zipf_frequency(word, 'fr') * math.log(10)  # rescale to fit
